  ...
  c.before :suite do
    ...
    hosts.each do |host|
      # Install and dep modules, e.g. 
         ...
         on host, puppet('module','install','jgazeley-selinux'), { :acceptable_exit_codes => [0,1] }
         on host, puppet('module','install','danfoster-sitefirewall'), { :acceptable_exit_codes => [0,1] }
    end
  end
end
